pkg_name=time-tracker
pkg_origin=roberthabitat
pkg_version="0.1.37"
#pkg_maintainer="The Habitat Maintainers <humans@habitat.sh>"
pkg_license=('Apache-2.0')
pkg_source="https://github.com/robertjebakumar/time-tracker"
...
#pkg_upstream_url="http://localhost:8080/g"
...
do_download()
    {
        ...
        mkdir ${pkg_dirname}
        cd ${pkg_dirname}
        GIT_SSL_NO_VERIFY=true git clone https://github.com/robertjebakumar/time-tracker.git
        return 0
    }
...
do_install()
    {
        ...
        #chmod +x ${source_dir}/time-tracker-0.1.37/time-tracker/web/target/time-tracker-web-0.3.1-SNAPSHOT.war
        mv ${source_dir}/web/target/time-tracker-web-0.3.1-SNAPSHOT.war ${webapps_dir}
